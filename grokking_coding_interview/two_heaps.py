...
def find_maximum_capital(
    capital: List[int], profits: List[int], numberOfProjects: int, intialCapital: int
):
    """
...
assert find_next_interval([Interval(2, 3), Interval(3, 4), Interval(5, 6)]) == [
    1,
    2,
    -1,
]
assert find_next_interval([Interval(3, 4), Interval(1, 5), Interval(4, 6)]) == [
    -1,
    2,
    -1,
]
